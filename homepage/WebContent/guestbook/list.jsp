...
<body>
	...
	<div class="container">
		<h2 style="color: white;">방명록 리스트</h2>
		<br>
		...
		<table class="table table-striped" style='background-color:배경색; filter: Alpha(Opacity=50);'>
			<thead>
				<tr>
					<th >번호</th>
					<th>제목</th>
